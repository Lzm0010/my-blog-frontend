...
function FooterLinks () {
    return(
        <div className={styles.footerLinks}>
            <a href="https://github.com/Lzm0010" target="_blank">
                <FontAwesomeIcon icon={faGithubSquare} size="4x" className={styles.faIcon} />
            </a>
            <a href="https://www.linkedin.com/in/lee-mccormick-ninja/" target="_blank">
                <FontAwesomeIcon icon={faLinkedin} size="4x" className={styles.faIcon} />
            </a>
            <a href="https://www.instagram.com/leemac6363/" target="_blank">
